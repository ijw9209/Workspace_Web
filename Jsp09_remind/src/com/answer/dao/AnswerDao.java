...
public interface AnswerDao {
	...
	String UPDATE_ANSWER_SQL = " UPDATE ANSWERBOARD SET GROUPSQ = GROUPSQ + 1 WHERE GROUPNO = (SELECT GROUPNO FROM ANSWERBOARD WHERE BOARDNO = ?) AND GROUPSQ > (SELECT GROUPSQ ROM ANSWERBOARD WHERE BOARDNO = ? )";
