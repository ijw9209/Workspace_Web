...
AND GROUPSQ >= (SELECT GROUPSQ FROM ANSWERBOARD WHERE BOARDNO = 7 ) ORDER BY GROUPNO DESC, GROUPSQ;

SELECT * FROM ANSWERBOARD ORDER BY GROUPNO DESC, GROUPSQ;
SELECT TITLETAB FROM ANSWERBOARD 
WHERE GROUPNO = (SELECT GROUPNO FROM ANSWERBOARD WHERE BOARDNO = 1)
AND GROUPSQ >= (SELECT GROUPSQ FROM ANSWERBOARD WHERE BOARDNO = 1)ORDER BY GROUPNO DESC, GROUPSQ;

SELECT * FROM ANSWERBOARD
WHERE GROUPSQ >= (SELECT GROUPSQ FROM ANSWERBOARD WHERE BOARDNO = 1)
	--1 2 3 4 5 			1 
AND GROUPSQ <(SELECT MIN(GROUPSQ) --1
			FROM ANSWERBOARD
			WHERE GROUPNO = (SELECT GROUPNO FROM ANSWERBOARD WHERE BOARDNO = 1)
--2 3 4..			1		
			AND TITLETAB = (SELECT TITLETAB FROM ANSWERBOARD WHERE BOARDNO = 1)
				-- 0
			AND GROUPSQ > (SELECT GROUPSQ FROM ANSWERBOARD WHERE BOARDNO = 1))
				--2 3 4
AND GROUPNO = (SELECT GROUPNO FROM ANSWERBOARD WHERE BOARDNO = 1) ORDER BY GROUPNO DESC, GROUPSQ;
--------------------------------------------------------------------------------------------------------------------------------------------
...
AND GROUPSQ <= (SELECT MIN(GROUPSQ) 
				FROM ANSWERBOARD 
				WHERE TITLETAB > (SELECT TITLETAB FROM ANSWERBOARD WHERE BOARDNO =1)
				
				AND GROUPSQ > (SELECT GROUPSQ FROM ANSWERBOARD WHERE BOARDNO = 1)
				AND GROUPNO = (SELECT GROUPNO FROM ANSWERBOARD WHERE BOARDNO = 1))
AND GROUPNO = (SELECT GROUPNO FROM ANSWERBOARD WHERE BOARDNO = 1); 
