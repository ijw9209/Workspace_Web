...
public class MemberDto {
	...
	public MemberDto(String myid, String mypw) {
		super();
		this.myid = myid;
		this.mypw = mypw;
	}
	...
	public MemberDto(int myno, String mypw, String myaddr, String myphone, String myemail) {
		super();
		this.myno = myno;
		this.mypw = mypw;
		this.myaddr = myaddr;
	...
	public MemberDto(String mypw, String myaddr, String myphone, String myemail) {
		super();
		this.mypw = mypw;
		this.myaddr = myaddr;
		this.myphone = myphone;
	...
	public MemberDto(String myid, String mypw, String myname, String myaddr, String myphone, String myemail,
			String myenabled) {
		super();
		this.myid = myid;
		this.mypw = mypw;
