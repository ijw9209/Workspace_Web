...
SELECT BOARDNO,TITLE,WRITER,REGDATE , R
FROM(SELECT ROWNUM AS R,BOARDNO, TITLE, WRITER, REGDATE
FROM(SELECT BOARDNO, TITLE, WRITER, REGDATE 
	  FROM ANSWERBOARD ORDER BY BOARDNO))
